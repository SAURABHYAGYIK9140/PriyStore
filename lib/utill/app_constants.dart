...
class AppConstants {
  static const String appName = 'PriyStore';
  static const String slogan = 'E-Commerce Marketplace';
  static const String appVersion = '1.4';
  static const String baseUrl = 'https://priystore.com';
  ...
  static const String recentProductUri = '/api/v1/products/recent?guest_id=1&limit=10&&offset=';
  static const String recomendedProductUri = '/api/v1/products/recomended?guest_id=1&limit=10&&offset=';
...
static const String otpVerificationForDigitalProduct = '/api/v1/customer/order/digital-product-download-otp-verify';
  ...
  static const String homebanners = '/api/v1/banners/get-home-top-banners';
  static const String get_deal_of_the_day_product = '/api/v1/products/dealofday?guest_id=1&limit=10&&offset=';
  ...
  static  int selectedsizeindex = -1;
  static  int selectedcoloreindex = 0;
  static  int? bundleid = 0;
  static  CategoryModel dhakadcategoryModel =new CategoryModel();
  static  String homesubcat = '';
  static  bool advance_payment = false;
