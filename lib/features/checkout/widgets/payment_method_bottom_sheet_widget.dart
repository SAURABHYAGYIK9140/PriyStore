...
@override
  void initState() {
    ...
    super.initState();
    print("aaaaaaaaaa"+CheckoutScreenState.amount);
     amount = (int.parse(CheckoutScreenState.amount.replaceAll(".00", "").replaceAll(",", "")) );
    int advancepercentage=int.parse(Provider.of<SplashController>(context, listen: false).configModel!.advancePercentage.toString());
    amount = (amount * advancepercentage) ~/ 100;
  ...
  Widget build(BuildContext context) {
    ...
    print("sssssssss"+AppConstants.advance_payment.toString());
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start,
                mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Row(children: [
                    ...
                    Visibility(
                      visible:  AppConstants.advance_payment!=true,
                    ...
                    Visibility(
                        visible:  AppConstants.advance_payment!=true,
                        child: const SizedBox(width: Dimensions.paddingSizeDefault)),
                  ...
                  Row(
                    children: [
                      // Flexible(child: CustomButton(onTap: () => checkoutProvider.setOfflineChecked('online'),
                      //     isBorder: true,
                      //     leftIcon: Images.payWallet,
                      //     backgroundColor: checkoutProvider.onlineChecked ? Theme.of(context).primaryColor : Theme.of(context).cardColor,
                      //     textColor:  checkoutProvider.onlineChecked? Colors.white : Theme.of(context).textTheme.bodyLarge?.color,
                      //     fontSize: Dimensions.fontSizeSmall,
                      //     buttonText: 'Pay online')),
                      // ( AppConstants.advance_payment)
                      //   ?
                      //     Visibility(
                      //         visible:  AppConstants.advance_payment,
                  ...
                  Visibility(
                    ...
                    child: Flexible(child: CustomButton(onTap: () => checkoutProvider.setOfflineChecked('advance'),
                        isBorder: true,
                        leftIcon: Images.payWallet,
                        backgroundColor: checkoutProvider.advanceChecked ? Theme.of(context).primaryColor : Theme.of(context).cardColor,
                        textColor:  checkoutProvider.advanceChecked? Colors.white : Theme.of(context).textTheme.bodyLarge?.color,
                        fontSize: Dimensions.fontSizeSmall,
                        buttonText: 'Advance payment')),
                  ),
                      Visibility(
                          visible:  AppConstants.advance_payment && checkoutProvider.advanceChecked,
                          child:  Text("Pay "+Provider.of<SplashController>(context, listen: false).configModel!.advancePercentage.toString()+' %  ₹'+amount.toString()+' in avdvance ', style: textRegular),
                      ),
                  ...
                  Padding(padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeSmall, top: Dimensions.paddingSizeDefault),
                    child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text(Provider.of<SplashController>(context, listen: false).configModel!.onlinePaymentOffer.toString()=='1'?' Save र'+Provider.of<SplashController>(context, listen: false).configModel!.onlinePaymentOfferAmount.toString():'', style: sptextRegular),
                        Expanded(child: Padding(padding: const EdgeInsets.only(left: Dimensions.paddingSizeExtraSmall),
