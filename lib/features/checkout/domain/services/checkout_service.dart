...
class CheckoutService implements CheckoutServiceInterface{
  ...
  @override
  Future digitalPaymentPlaceOrder(String? pay_in_advance,String? orderNote, String? customerId, String? addressId, String? billingAddressId, String? couponCode, String? couponDiscount, String? paymentMethod) async {
    return await checkoutRepositoryInterface.digitalPaymentPlaceOrder(pay_in_advance,orderNote, customerId, addressId, billingAddressId, couponCode, couponDiscount, paymentMethod);
  }
