...
class _OrderDetailsState extends State<OrderDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    print("orderDetailsModel"+  (double.parse(widget.orderDetailsModel.price.toString())).toString());
    print("unitPrice"+  (double.parse(widget.orderDetailsModel.product!.unitPrice.toString())).toString());
    return Stack(children: [
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Row(children: [
                      ...
                      Text(PriceConverter.convertPrice(context,
                          (double.parse(widget.orderDetailsModel.product!.unitPrice.toString())) -
                              (double.parse(widget.orderDetailsModel.discount.toString()))),maxLines: 1,
