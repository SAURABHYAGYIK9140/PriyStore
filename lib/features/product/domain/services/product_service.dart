...
class ProductService implements ProductServiceInterface{
  ...
  @override
  Future getBrandOrCategoryProductList(String catd,String frombanner,bool isBrand, String id) async{
    return await productRepositoryInterface.getBrandOrCategoryProductList(catd,frombanner,isBrand, id);
  }
  ...
  @override
  Future getRecentProductList(String offset) async{
    return await productRepositoryInterface.getRecentProductList(offset);
  }
  @override
  ...
  @override
  Future getRecommendedProductList(String offset) async {
    return await productRepositoryInterface.getR2mendedProductList(offset);
  }

  @override
  Future getDeal2prolist(String offset) async {
    // TODO: implement getDeal2prolist
    return await productRepositoryInterface.getDeal2prolist(offset);
  }
