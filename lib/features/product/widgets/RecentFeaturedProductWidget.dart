...
class Recentfeaturedproductwidget extends StatelessWidget {
  final ScrollController? scrollController;
  final bool isHome;
  String type;

   Recentfeaturedproductwidget({super.key,  this.scrollController, required this.isHome, required this.type});
