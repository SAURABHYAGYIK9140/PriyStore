...
class CartWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print("CartWidget"+cartModel!.color_image.toString());
    print("quantityquantity"+cartModel!.pricedisbundle.toString());
    print("quantityquantity"+cartModel!.quantity.toString());

    var splashController = Provider.of<SplashController>(context,listen: false);
    return Consumer<CartController>(
      builder: (context, cartProvider, _) {
        String imageurl='${splashController.baseUrls?.productThumbnailUrl}/${cartModel?.thumbnail}';
        if(cartModel!.color_image!=null)
          {
             imageurl=AppConstants.baseUrl+'/storage/app/public/product/'+cartModel!.color_image.toString();

          }
        if( cartModel?.is_print == '1')
          {
            AppConstants.advance_payment=true;
          }else{

          AppConstants.advance_payment=false;
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                        mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          Row(children: [cartModel!.discount!>0?
                            ...
                            Text(PriceConverter.convertPrice(context, cartModel!.price!-(cartModel!.pricedisbundle/cartModel!.quantity),
                              ...
                              Column(
                                children: [
                                  Row(
                                    children: [
                                      Text(
                                        "Print Remark : "+cartModel!.print_remark.toString(),
                                    ...
                                    children: [
                                      ...
                                      SingleChildScrollView(
                                        ...
                                        child: Row(
                                          children: [
                                            for (int i = 0;
                                            i < cartModel!.print_image!.length;
                                            i++)
                                              SingleChildScrollView(
                                                scrollDirection: Axis.horizontal,
                                                child: Padding(
