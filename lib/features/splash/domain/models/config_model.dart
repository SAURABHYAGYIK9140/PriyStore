class ConfigModel {
  String? onlinePaymentOfferAmount;
  String? onlinePaymentOffer;
  ...
  ConfigModel(
      {
        this.onlinePaymentOfferAmount,
        this.onlinePaymentOffer,
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    onlinePaymentOfferAmount = json['online_payment_offer_amount'];
    onlinePaymentOffer = json['online_payment_offer'];
...
class BaseUrls {
  ...
  BaseUrls.fromJson(Map<String, dynamic> json) {
    ...
    proImageUrl = json['pro_image_url'];
