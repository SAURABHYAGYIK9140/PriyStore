...
class CartBottomSheetWidgetState extends State<CartBottomSheetWidget> {
  ...
  @override
  void initState() {
    _selectedcolorIndex= AppConstants.selectedcoloreindex;
    _selectedOptionIndex= AppConstants.selectedsizeindex;
    // Provider.of<ProductDetailsController>(context, listen: false).initData(
    //     widget.product!, widget.product!.minimumOrderQty, context);
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    final productController = Provider.of<ProductDetailsController>(context);
    print("_variationIndex"+productController.variationIndex.toString());
      ...
      Container(
        ...
        child: Consumer<ProductDetailsController>(
          builder: (ctx, details, child) {
            // print("_variationIndex"+details.variationIndex.toString());

            String? colorWiseSelectedImage = '';

            if (widget.product != null && widget.product!.colorImage != null &&
                widget.product!.colorImage!.isNotEmpty) {
              for (int i = 0; i < widget.product!.colorImage!.length; i++) {
                if (widget.product!.colorImage![i].color ==
                    '${widget.product!.colors?[details.variantIndex ?? 0].code
                        ?.substring(1, 7)}') {
            ...
            avg.toString() : "0";
            print("is_print" + details.is_print.toString());
            print("print_image" + details.print_image.toString());
            print("print_remark" + details.print_remark.toString());
            print("listsss" + details.imageFileslist!.length.toString());
            CartModelBody cart = CartModelBody(
              ...
              is_print: details.is_print,
              print_image: details.print_image,

              imageFileslist: details.imageFileslist,
              print_remark: details.print_remark,
            ...
            return Column(
                            ...
                            Container(width: 100, height: 100,
                                ...
                                child: ClipRRect(
                                    ...
                                    child: CustomImageWidget(
                                        image: (widget.product!.colors !=
                                            null && widget.product!.colors!
                                            .isNotEmpty &&
                                        ...
                                        '${Provider
                                            ...
                                            .baseUrls!
                                            .productImageUrl}/$colorWiseSelectedImage'
                                            :
                                        '${Provider
                                            .of<SplashController>(
                                            context, listen: false)
              ...
              ColorSelectionWidget(
                  product: widget.product!, detailsController: details)
                  : const SizedBox(),
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (ctx, i) {
                              return Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall),
                                child: InkWell(onTap: () => {
                                  setState(() {
                                details.setCartVariationIndex(widget.product!.minimumOrderQty, index, i, context);
                                  })
                                },
              ...
              Padding(padding: const EdgeInsets.symmetric(
                  ...
                  child: Row(children: [
                    Text(getTranslated('quantity', context)!,
                        style: textMedium.copyWith(fontSize: Dimensions
                            .fontSizeLarge)),
                    ...
                    QuantityButton(isIncrement: false,
                        ...
                        digitalProduct: widget.product!.productType ==
                            "digital"),

                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: Dimensions
                          .paddingSizeSmall),
                      child: Text(details.quantity.toString(), style: textMedium
                  ...
                  child: Row(
                    ...
                    Padding(padding: const EdgeInsets.only(top: Dimensions
                        ...
                        child: Text('(${getTranslated(
                            'tax', context)} : ${widget.product?.tax}%)',
                            style: titilliumRegular.copyWith(
              ...
              CustomButton(backgroundColor: Theme
                  .of(context)
                  .colorScheme
                  .error
                  .withOpacity(.10),
              ...
              Container(color: Theme
                ...
                child: Padding(padding: const EdgeInsets.symmetric(
                  ...
                  child: Row(
                    ...
                    Expanded(child: CustomButton(isBuy: true, radius: 6,
                    ...
                    Expanded(
                      child: CustomButton(radius: 6,
                        ...
                        // if(ProductDetailsState.addimagecheck==true && ProductDetailsState.imageFiles!.isEmpty)
                        //   {
                        //     Navigator.pop(context);
                        //     ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        //         backgroundColor: const Color(0xFFFF3130),
                        ...
                        //   }
                            if (stock! >= widget.product!.minimumOrderQty! ||
                              ...
                              Provider.of<CartController>(
                                  context, listen: false).addToCartAPI(
                                  cart, context, widget.product!.choiceOptions!,
                                  details.variationIndex);
                            }
                          }),),
        ...
        if (!isIncrement && quantity! > 1) {
          if (quantity! > minimumOrderQuantity!) {
            ...
            showCustomSnackBar('${getTranslated(
                'minimum_quantity_is', context)}$minimumOrderQuantity', context,
                isToaster: true);
          }
