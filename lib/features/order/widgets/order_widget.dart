...
class OrderWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // print('imageeggege -> ${Provider.of<SplashController>(context, listen: false).configModel?.baseUrls?.shopImageUrl}/${orderModel?.seller?.shop?.image}');
    print('imageeggege -> ${Provider.of<SplashController>(context, listen: false).configModel?.baseUrls?.proImageUrl}/${orderModel!.details?[0].product?.thumbnail}');
                    ...
                    Container(decoration: BoxDecoration(color: Theme.of(context).cardColor,
                      ...
                      child: ClipRRect(
                        ...
                        child: CustomImageWidget(
                          ...
                          image: '${Provider.of<SplashController>(context, listen: false).configModel?.baseUrls?.proImageUrl}/${orderModel!.details?[0].product?.thumbnail}',
                          ))
                      ,),]),),
