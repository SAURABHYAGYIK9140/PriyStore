...
class HomePage2 extends StatefulWidget {
  ...
  @override
  State<HomePage2> createState() => _HomePageStat2e();
}

class _HomePageStat2e extends State<HomePage2> {
  final ScrollController _scrollController = ScrollController();


  Future<void> _loadData(bool reload) async {
    Provider.of<BannerController>(Get.context!, listen: false).getBannerList(reload);
    Provider.of<CategoryController>(Get.context!, listen: false).getCategoryList(-1,reload);
